...
class CreateUserRolesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_roles', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->foreign('UserID')->references('id')->on('users')->constrained()->cascadeOnDelete()->restrictOnDelete();
            $table->foreign('RoleID')->references('id')->on('roles')->constrained()->cascadeOnDelete()->restrictOnDelete();
        });
    }
