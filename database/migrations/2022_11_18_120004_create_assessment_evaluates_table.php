...
class CreateAssessmentEvaluatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('assessment_evaluates', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('assessment_evaluates');
    }
}
